...
plot $goal notitle lt rgb '#228b22' lw 2, \\
     '$dir_prog/drive_2015.dat' using (timecolumn(1)+365*24*60*60*7+24*60*60*2):2 title '2015' lt rgb '#e0c492'  pt 7 ps .6, \\
     '$dir_prog/drive_2016.dat' using (timecolumn(1)+365*24*60*60*6+24*60*60*1):2 title '2016' lt rgb '#323d77'  pt 7 ps .6, \\
     '$dir_prog/drive_2017.dat' using (timecolumn(1)+365*24*60*60*5+24*60*60*1):2 title '2017' lt rgb '#ff0000'  pt 7 ps .6, \\
     '$dir_prog/drive_2018.dat' using (timecolumn(1)+365*24*60*60*4+24*60*60*1):2 title '2018' lt rgb '#ffce00'  pt 7 ps .6, \\
     '$dir_prog/drive_2019.dat' using (timecolumn(1)+365*24*60*60*3+24*60*60*1):2 title '2019' lt rgb '#42b0a3'  pt 7 ps .6, \\
     '$dir_prog/drive_2020.dat' using (timecolumn(1)+365*24*60*60*2+24*60*60*0):2 title '2020' lt rgb '#ff7062'  pt 7 ps .6, \\
     '$dir_prog/drive_2021.dat' using (timecolumn(1)+365*24*60*60*1+24*60*60*0):2 title '2021' lt rgb '#ad114c'  pt 7 ps .6, \\
     '$dir_prog/drive_2022.dat' using 1:2                                         title '2022' lt rgb '#88f2cb'  pt 7 ps .9
...
system ("rclone copy $dir_prog/bgg_2022.png gdrive:bgg_drive");
