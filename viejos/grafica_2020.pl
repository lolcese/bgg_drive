...
set label 'Goal' at '2020-12-02 00:00',18400 font 'Sans,11'

plot $goal notitle lt rgb '#228b22' lw 2, \\
     '$dir_prog/drive_2015.dat' using (timecolumn(1)+365*24*60*60*5+24*60*60*2):2 title '2015' lt rgb '#e0c492'  pt 7 ps .6, \\
     '$dir_prog/drive_2016.dat' using (timecolumn(1)+365*24*60*60*4+24*60*60*1):2 title '2016' lt rgb '#323d77'  pt 7 ps .6, \\
     '$dir_prog/drive_2017.dat' using (timecolumn(1)+365*24*60*60*3+24*60*60*1):2 title '2017' lt rgb '#ff0000'  pt 7 ps .6, \\
     '$dir_prog/drive_2018.dat' using (timecolumn(1)+365*24*60*60*2+24*60*60*1):2 title '2018' lt rgb '#ffce00'  pt 7 ps .6, \\
     '$dir_prog/drive_2019.dat' using (timecolumn(1)+365*24*60*60*1+24*60*60*1):2 title '2019' lt rgb '#42b0a3'  pt 7 ps .6, \\
     '$dir_prog/drive_2020.dat' using 1:2                                         title '2020' lt rgb '#ff7062'  pt 7 ps .9
...
# set xlabel 'Day (UTC)'
# set ylabel '2020 supporters minus 2019 supporters [%]' tc rgb 'blue'
# set y2label '2020 supporters minus 2019 supporters' tc rgb 'red'
...
system ("rclone copy $dir_prog/bgg_2020.png LuisUNC:bgg_drive");
